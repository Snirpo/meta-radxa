...
SRC_URI = " \
	file://install-module-hci-uart.service;name=btmodule-rockpis-service \
	file://rtl8723ds-btfw-load.service;name=btfw-rockpis-service \
	file://install_module_hci_uart;name=btmodule-rockpis-script \
"
